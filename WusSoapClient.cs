...
namespace Wus2026
{
    public class WusSoapClient
    {
        ...
        public readonly X509Certificate2 _clientCertificate;
        public readonly X509Certificate2 _serverCertificate;
        public readonly HttpClient _httpClient;

        public WusSoapClient(X509Certificate2 clientCertificate, X509Certificate2 serverCertificate, bool usingValidateServerCertificate = true)
        {
            ...
            if (usingValidateServerCertificate)
            {
        ...
        private sealed class KeyInfoSecurityToken(XmlElement element) : KeyInfoClause
        {
            private XmlElement _element = element ?? throw new ArgumentNullException(nameof(element));
